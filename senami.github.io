...
<html lang="en">
<head>
 <!--This is a link, that linked HTML to CSS-->
    <link rel="stylesheet" href="style.css">

    <div class="nee">
      <!--This is another link, that linked Home-->
<a href="Home.html">Home</a>

     <!--This is another link, that linked About us-->
    <a href="About.html">About</a>

     <!--This is another link, that linked Contact us-->
